 ...
 */
class Lm_Featured_Post_Metaboxes {
	    ...
	    <div class="form-group">
	        <div class="form-check">
	          <label class="form-check-label">
	            <input class="form-check-input" type="checkbox" name="lmfp_is_featuredpost" id="is_featuredpost" value="1" <?php echo ( $is_featuredpost == 1 ? 'checked' : '' ); ?>>
	            <?php _e( 'Make this post a Featured Post.', 'lm-featured-post' ); ?>
	          </label>
	        </div>
	    </div>
	    <div class="form-group form-text-line">
	        <label><?php _e( 'Featured Post Title', 'lm-featured-post' ); ?></label>
	        <input type="text" class="form-control" name="lmfp_custom_title" id="custom_title" value="<?php echo $custom_title; ?>">
	    </div>
	    <div class="form-group">
	        <div class="form-check">
	          <label class="form-check-label">
	            <input class="form-check-input" type="checkbox" name="lmfp_has_expiration_date" id="has_expiration_date" value="1" <?php echo ( $has_expiration_date == 1 ? 'checked' : '' ); ?>>
	            <?php _e( 'This Featured Post has an expiration date.', 'lm-featured-post' ); ?>
	          </label>
	        </div>
	    </div>    
	    <div class="form-group form-text-line" id="expiration-datetime" <?php if ( $has_expiration_date != 1 ){ echo 'style="display:none;"'; } ?> >
	        <label><?php _e( 'Expiration Date', 'lm-featured-post' ); ?></label>
	        <input type="text" class="form-control MyDate" name="lmfp_expiration_date" id="expiration_date" value="<?php echo $expiration_date; ?>"><br> 
	        <label><?php _e( 'Expiration Time', 'lm-featured-post' ); ?></label>
	        <input class='timepicker' type='text' name="lmfp_expiration_time" id="expiration_time" value="<?php echo $expiration_time; ?>" />
	    </div>
	    <?php
	}
	...
	public function validate_meta( $post_id, $object ) {
		...
		if ( 'post' !== $object->post_type ) { return $post_id; }
		...
		if($new_value['lmfp_is_featuredpost'] == 1){
			...
			if( $expire_featured_post != true ){
				...
				if( $new_value['lmfp_has_expiration_date'] == 1 ){
